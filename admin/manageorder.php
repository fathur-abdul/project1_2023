...
<head>
    ...
    <title>Kelola Pesanan - FitySixStore</title>
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											$orderids = $p['orderid'];
												...
												$result1 = mysqli_query($conn,"SELECT SUM(d.qty*p.hargaafter+10000) AS count FROM detailorder d, produk p where orderid='$orderids' and p.idproduk=d.idproduk order by d.idproduk ASC");
